...
class webtoon extends Controller
{
	...
	{
		// Khởi tạo một đối tượng chapterModel
		$chapterModel = $this->load->model("chapterModel");

		// Lấy danh sách truyện kèm số lượng chương từ chapterModel
		$data['webtoons'] = $chapterModel->selectWebtoonWithChapter($this->table);
